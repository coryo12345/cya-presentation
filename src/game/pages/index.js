...
Currently, there are ${endings.getTotalEndingCount()} possible endings. Whether an ending is good or bad is subjective. Some endings are based on random chance. Not every ending is from a death, some are just the conclusion of a story.`,
